...
class PanelProvider {
    constructor(context, htmlCaptureProvider, htmlComparator) {
    ...
    async showBaselineDetails(baseline) {
        const panel = vscode.window.createWebviewPanel('baselineDetails', `Baseline: ${baseline.name}`, vscode.ViewColumn.One, {
            enableScripts: true,
            retainContextWhenHidden: true
        });
        panel.webview.html = this.generateBaselineDetailsHTML(baseline);
    }
    generateBaselineDetailsHTML(baseline) {
